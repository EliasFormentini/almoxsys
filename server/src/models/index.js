...
const Pedido = require("./pedidos")(sequelize);
const ItemPedido = require("./item_pedido")(sequelize);
const Movimentacao = require("./movimentacoes")(sequelize);
const Fornecedor = require("./fornecedores")(sequelize);
