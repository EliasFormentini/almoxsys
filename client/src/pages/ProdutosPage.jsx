...
//     const categoriaMatch = categoriaFiltro ? p.id_categoria === parseInt(categoriaFiltro) : true;
//     const saldoMatch = comSaldo ? p.estoque_atual > 0 : true;
//     const abaixoMatch = abaixoMinimo ? p.estoque_atual < p.estoque_minimo : true;
//     const statusMatch = exibirInativos ? true : p.status === "A";

//     return nomeMatch && categoriaMatch && saldoMatch && abaixoMatch && statusMatch;
//   });
...
//             className="border border-gray-300 rounded-md px-3 py-2 w-full focus:ring-2 focus:ring-blue-500 outline-none"
//           />
...
//               <th className="px-4 py-3 border-b text-left">Categoria</th>
//               <th className="px-4 py-3 border-b text-left">Unidade</th>
//               <th className="px-4 py-3 border-b text-center">Estoque Atual</th>
//               <th className="px-4 py-3 border-b text-center">Estoque Mínimo</th>
...
//                     produto.status === "I" ? "opacity-60" : ""
//                   }`}
//                 >
//                   <td className="px-4 py-2 border-b text-gray-700">{produto.id}</td>
//                   <td className="px-4 py-2 border-b">{produto.nome}</td>
//                   <td className="px-4 py-2 border-b">{produto.categoria?.nome || "-"}</td>
//                   <td className="px-4 py-2 border-b">{produto.unidade?.sigla || "-"}</td>
//                   <td
...
//                   </td>
//                   <td className="px-4 py-2 border-b text-center">{produto.estoque_minimo}</td>
  ...
  const sorted = useMemo(() => {
    ...
    const getComparable = (p, key) => {
      switch (key) {
        ...
        case "unidade":
          // pode exibir descrição ou sigla — aqui usamos a sigla na tabela
